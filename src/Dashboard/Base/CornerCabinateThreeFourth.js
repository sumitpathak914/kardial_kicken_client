...
const CornerCabinateThreeFourth = () => {
    ...
    const initialItems = [
        ...
        { description: "Acrylic Shutter 1", width: 350, thick: 18, height: 770, rate: 1470, unit: "SQ/FT", qty: 1, UNIT: "SQ/FT", remark: "MARINE PLY" },
        { description: "Acrylic Shutter 2", width: 300, thick: 19, height: 770, rate: 1470, unit: "SQ/FT", qty: 1, UNIT: "SQ/FT", remark: "MARINE PLY" },
        { description: "Legs", width: 0, height: 0, rate: 400, unit: "Set", remark: "HETTICH"},
        { description: "Skirting", width: 950, height: 1, rate: 0.66, unit: "SQ/FT", remark: "MARINE PLY" },
        ...
        if (field === "width") {
            ...
            if (updatedItems[index].description === "Acrylic Shutter 1") {
                ...
                if (labourChargesItem) {
                    labourChargesItem.width = newValue; // Update Labour Charges width based on Acrylic Shutter 1 width
                }
            }
        }

        // Update height for all items except "Legs" and "Labour Charges" when "Base Cabinet" height is changed
