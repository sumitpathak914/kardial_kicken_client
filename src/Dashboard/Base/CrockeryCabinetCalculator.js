...
//     ];
//     console.log(components,"crockery cabinet calculte ")
//     let totalPrice = 0;
...
// const CrockeryCabinetCalculator = ({ width, thick, height, onRateUpdate }) => {
...
// export default CrockeryCabinetCalculator;
import { useState, useEffect } from "react";
...
const CornercabinateThreeFourthCalcultor = ({ width, thick, height, onRateUpdate, setExposeData, exposeData, exposeDataBottom, setExposeDataBottom, setExposeDataBack, exposeDataBack }) => {
    const [ratePerSqFt, setRatePerSqFt] = useState(600);
    const [backRate, setBackRate] = useState(360);
