...
//     const areaInSquareFeet = (w * d * quantity) / (304.8 * 304.8);
...
// const CornercabinateCalcultor = ({ width, thick, height, onRateUpdate }) => {
...
// export default CornercabinateCalcultor;
import { useState, useEffect } from "react";
...
const CornercabinateCalcultor = ({ width, thick, height, onRateUpdate, setExposeData, exposeData, exposeDataBottom, setExposeDataBottom, setExposeDataBack, exposeDataBack }) => {
            ...
            {showModalExpose && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded shadow-lg w-1/2">
                        <h2 className="text-lg font-bold mb-4">Select Exposure Type</h2>
                        ...
                        {selectedExpose === "side" && (
                            <>
                                <table className="w-full border-collapse border border-gray-300 mt-4">
                                    <thead>
                                        <tr className="bg-gray-100">
                                            ...
                                            <th className="border p-2">Sq Foot</th>
                                    ...
                                    <tbody>
                                        {exposeData.map((item, index) => (
                                            <tr key={index}>
                                                <td className="border p-2">{item.thick}</td>
                                                <td className="border p-2">{item.height}</td>
                                                <td className="border p-2">{item.qty}</td>
                                                <td className="border p-2">{item.rate}</td>
                                                <td className="border p-2">{item.sqFoot}</td>
                                        ...
                                        {isAdding && (
                                            <tr>
                                                ...
                                                <td className="border p-2">{newExpose.sqFoot}</td>
                                                <td className="border p-2">{newExpose.total}</td>
                                                <td className="border p-2">
                                                    {editingIndex === null ? (
                                                        // <button onClick={addExpose} className="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600">Add</button>
                                                        null

                                                    ) : (
                                                        <button onClick={saveEdit} className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">Save</button>
                                                    )}
                                                </td>
                                            </tr>
                                        )}
                                ...
                                <div className="flex gap-5 mt-5">
                                    ...
                                    {/* Close Button */}
                                    <button onClick={() => setShowModalExpose(false)} className=" p-2 bg-red-500 text-white rounded">
                                        Close
                                    </button>
                                </div>
                            </>
                            ...
                            <>
                                <table className="w-full border-collapse border border-gray-300 mt-4">
                                    <thead>
                                        <tr className="bg-gray-100">
                                            <th className="border p-2">Width</th>
                                            <th className="border p-2">thick</th>
                                            <th className="border p-2">Quantity</th>
                                            <th className="border p-2">Rate</th>
                                            <th className="border p-2">Sq Foot</th>
                                            <th className="border p-2">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        {isAddingBottom && (
                                            <tr>
                                                ...
                                                <td className="border p-2">{newExposeBottom.sqFoot}</td>
                                                <td className="border p-2">{newExposeBottom.total}</td>
                                                <td className="border p-2">
                                                    {editingIndex === null ? (
                                                        // <button onClick={addExpose} className="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600">Add</button>
                                                        null
                                                        ...
                                                        <button onClick={saveEditBottom} className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">Save</button>
                                                    )}
                                                </td>
                                            </tr>
                                        )}
                                    ...
                                    <tbody>
                                        ...
                                        {isAddingBack && (
                                            <tr>
                                                ...
                                                <td className="border p-2">{newExposeBack.sqFoot}</td>
                                                <td className="border p-2">{newExposeBack.total}</td>
                                                <td className="border p-2">
                                                    {editingIndex === null ? (
                                                        // <button onClick={addExpose} className="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600">Add</button>
                                                        null
                                                        ...
                                                        <button onClick={saveEditBack} className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600">Save</button>
                                                    )}
                                                </td>
                                            </tr>
                                        )}
