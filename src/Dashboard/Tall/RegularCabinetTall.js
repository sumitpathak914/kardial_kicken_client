...
// export default RegularCabinetTall

import React, { useState, useEffect } from "react";
import RegualrcabinetTallCalcultor from "./RegualrcabinetTallCalcultor";
...
const RegularCabinetTall = () => {
    ...
    const initialItems = [
        { description: "Base Cabinet", width: 600, thick: 600, height: 2100, rate: 5124, unit: "MODUL", qty: 1, remark: "MARINE PLY" },
        { description: "Acrylic Shutter", width: 600, thick: 18, height: 2100, rate: 1470, unit: "SQ/FT", qty: 1, remark: "MARINE PLY" },
        ...
        { description: "Skirting", width: 600, thick: 18, height: 350, rate: 0.66, unit: "SQ/FT", qty: 1, remark: "MARINE PLY" },
    ...
    //         // Find and update the height of Acrylic Shutter & Labour Charges to match Base Cabinet
    ...
    return (
        <div className="p-6 ">
            <h2 className="mb-4 text-2xl font-bold">TALL REGULAR CABINET</h2>
                ...
                <tbody>
                    {filteredItems.map((item, index) => (
                        <tr key={index} className="bg-white">
                            ...
                            <td className="p-2 border">
                                {item.description && item.description !== "Legs" &&
                                    item.description !== "Labour Charges" && item.description !== "Skirting" && (
                                    <input
                                        type="number"
                                        value={item.thick || ""}
                                        className="w-full p-1 border rounded"
