...
// export default OpenCabinetExpose
...
const OpenCabinetExpose = ({ setExposeData, exposeData, exposeDataBottom, setExposeDataBottom, setExposeDataBack, exposeDataBack }) => {
