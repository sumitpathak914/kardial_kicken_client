...
const CrockeryWallCabinetCalculator = ({ width, thick, height, onRateUpdate, setExposeData, exposeData, exposeDataBottom, setExposeDataBottom, setExposeDataBack, exposeDataBack }) => {
...
export default CrockeryWallCabinetCalculator;