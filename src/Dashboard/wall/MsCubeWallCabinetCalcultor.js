...
// const MsCubeWallCabinetCalcultor = () => {
//   return (
//     <div>
...
const calculateRate = (width, thick, height) => {
    ...
    const components = [
        { name: "MS CUBE", w: thick, d: height, quantity: 1, rate: ratePerSqFt },
        { name: "SHELF WOODEN", w: width, d: 100, quantity: 2, rate: ratePerSqFt },
        { name: "bottom", w: width, d: thick, quantity: 1, rate: ratePerSqFt },
        { name: "back", w: width, d: height - 26, quantity: 1, rate: backRate },
    ];
...
const MsCubeWallCabinetCalcultor = ({ width, thick, height, onRateUpdate }) => {
...
export default MsCubeWallCabinetCalcultor;
