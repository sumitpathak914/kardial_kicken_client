...
// export default BottomOrBackExposeWall
import React, { useState, useEffect } from "react";

const BottomOrBackExposeWall = () => {
    // Sample data for different items
    const initialItems = [
        { description: "PANEL", width: 920, thick: 19, height: 600, rate: 1470, unit: "MODUL", qty: 1 },
        { description: "Labour Charges", width: 920, height: 600, rate: 100, unit: "SQ/FT", qty: 1 },
    ];
